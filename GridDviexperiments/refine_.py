...
###### all grid + training 
# N_NEIGHBORS = 30
spatial_cons = SingleEpochSpatialEdgeConstructorForGrid(data_provider, border_centers, epoch, S_N_EPOCHS, B_N_EPOCHS, N_NEIGHBORS,error_list,only_grid=False)
###### only grid 
...
data_ = data_provider.train_representation(epoch)[error_list][:3]



trainer = DVIReFineTrainer(pre_model, criterion, optimizer, lr_scheduler, edge_loader, DEVICE, data_, disable_encoder_grad = False)
