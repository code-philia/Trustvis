...
file_path = os.path.join(CONTENT_PATH, "Model", "Epoch_{}".format(epoch), "{}.pth".format('tvi'))
...
trainer.save(save_dir=save_dir, file_name="{}".format('dvi_grid_bon2'))
...
def if_border(data):
    ...
    return border
projector = DVIProjector(vis_model=model, content_path=CONTENT_PATH, vis_model_name='dvi_grid_bon2', device=DEVICE)  
