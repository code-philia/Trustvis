...
model_location = os.path.join(model_path, "{}_{:d}".format('Epoch', 60), "subject_model.pth")
pre_trained_model = load_model(model_location)

train_data, train_labels = load_data(os.path.join(model_path, "{}_{:d}".format('Epoch', 60), "training_data.npy"), 'train_labels.npy')
...
def train_s_t():
    ...
    save_dir = os.path.join(content_path,"Model","Epoch_{}".format(60)) +'adv/'
