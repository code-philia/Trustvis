...
MAX_EPOCH = 2
VIS_MODEL_NAME = 'trustvis_dynamic' ### saved_as VIS_MODEL_NAME.pth
...
for iteration in range(EPOCH_START, EPOCH_END+EPOCH_PERIOD, EPOCH_PERIOD):
    ...
    if start_flag:
        ...
        model_location = os.path.join(data_provider.model_path, "{}_{}".format('Epoch', iteration), "trustvis_fixed.pth")

        save_model = torch.load(model_location, map_location="cpu")
